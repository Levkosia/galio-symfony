...
<div class="topbar">
    <div class="container">
        ...
        <div class="topbar-right">
            <ul class="topbar-nav clearfix">
                <li><a href="/registration" class="login">Login</a></li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="language dropdown-toggle" data-toggle="dropdown"><img src="assets/images/flag-us.png" alt=""> English</a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="#"><img src="assets/images/flag-us.png" alt=""> &nbsp;English</a></li>
            ...
            <div class="top-cart-title">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="cart-listing">
                        <div class="media">
                            <div class="media-left"><a href="#"><img src="assets/images/products/11.jpg" alt="" class="img-responsive"></a></div>
                        ...
                        <div class="media">
                            <div class="media-left"><a href="#"><img src="assets/images/products/13.jpg" class="img-responsive" alt=""></a></div>
                            <div class="media-body">
                                <button type="button" class="remove-cart-item" >&times;</button>
                                <h4>Accumsan elit</h4>
                                <div class="mini-cart-qty">Qty:2</div>
                ...
                <div class="col-md-6 has-sep">
                    <div class="custom-menu-right">
                        <div class="box-banner media">
                            ...
                            <div class="media-right"><img src="assets/images/products/img-01.jpg" alt=""></div>
                        </div>
                        <div class="box-banner media">
                            <div class="media-body">
                                <h3>Lens Fulters</h3>
                            ...
                            <div class="media-right"><img src="assets/images/products/img-02.jpg" alt=""></div>
                        </div>
                        <div class="box-banner media">
                            <div class="media-body">
                                <h3>Flashes</h3>
                            ...
                            <div class="media-right"><img src="assets/images/products/img-03.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
            <br>
            <a href="#" class="ads"><img alt="" src="assets/images/ads/ads-08.jpg" class="img-responsive"></a>
        </div>
    </div>
</li>
<li>
